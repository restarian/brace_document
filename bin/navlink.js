...
.usage(print().l(
"[options] [directory] -- This directory is the base path where the markdown files to mutate are",
" found. The default directory is the directory where the script was started.", "Important: the",
" directory must be relative to the project root dir. The project root is the directory which",
" contains.git repository. This is done so that the links will work when click within a http",
" platform.", "",
...
" by the heading: #[#,..] [specified navlink title]", "",
" If an existing navigation list is not found than it will be injecte below the first sub-heading found in the file.",
...
" string than one will be ceeated underneath the sub-heading found above.").toString())
