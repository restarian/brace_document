...
define(["bracket_print", "bracket_utils", "./sort"], function(print, utils, sort) {
	...
	var def = function(up, cb, err) {
		...
		this.reverse_sort = this.sort = this.relative_backup_dir = this.relative_docs_dir = this.project_root = this.origin_url = ""
