				...
				file_path.forEach(value => {
					...
					fs.readFile(value, undefined, (error, content) => {
						...
						if ( error )
							...
							err(this.up_err.log("A sub-heading (##[#,..]), could not be found in document", "").t(value).a(". It will be skipped.").toString())
						else
