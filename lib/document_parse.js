...
define(["bracket_print", "./sort"], function(print, sort) {
	...
	var def = function(up, cb, err) {
		...
		if ( up instanceof print ) 
			...
			if ( typeof up === "function" )
				cb = up
			this.up = up = print({title_stamp: false}, "document parse")
		}
		...
		this.recursive = this.force_title = false
		this.reverse_sort = this.sort = ""
	...
	def.prototype = { 
		...
		create_navlink: function(structure, page_data, location, navlink_url, cb, err) {
